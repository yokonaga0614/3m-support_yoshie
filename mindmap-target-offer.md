...
※ペルソナの**願望**は、社長×長野の「不安定からの解放→再発不安→自分に軸」という整理で書き直し済み。  
...
- 【重量鳶・採用オファー設計】
  ...
  - ターゲット設定（仮説ペルソナ・前回提出）
    ...
    - 願望（収入以外・書き直し版／社長×長野の整理）
      - この先の不安・会社都合で身を切られそうな状態から抜け、不安定さから解放されたい
      - 会社の都合で自分の人生を振り回されたくない（いつ潰れるかビクビクを減らしたい）
      - 全く別業界ではなく、建設・現場の延長で「仕事と給料が途切れにくい」会社に移りたい
      - 「うちは安泰」と言われても、また同じ目に遭うのでは…という疑いを下げたい
      - だから今度は自分に「業界の中で説明できる看板・資格・実力」を持ち、選択肢を増やしたい
        - 表現注意：「どこでも潰しが効く」は強すぎる→転職時の説明力・信頼の根拠レベルに言い換え
      - 資格（玉掛け等）を活かしつつ、次の現場でも評価される働き方がしたい
      - 職人同士の消耗が激しい人間関係からは距離を置き、淡々と仕事に集中できる環境がいい
      - 家族に「ここなら当面大丈夫」と説明できる土台（過大な「永遠安泰」表現はしない）
